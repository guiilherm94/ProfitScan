...
import {
    ...
    ChevronRight, ChevronDown, Trash2, Shield, Settings, CheckCircle
} from 'lucide-react'
...
export default function DashboardPage() {
    ...
    // Calculate results (but only show after button click)
    ...
    // New: Handle Calculate button click
    const handleCalculate = async () => {
        ...
        try {
            // Save to history (without AI response)
            const { data: historyData, error } = await supabase.from('history').insert({
                ...
                resposta_ia: null // No AI response yet
            }).select('id').single()
            ...
            // Enforce minimum 3 seconds loading
    ...
    // Modified: Handle AI Analyze (updates existing history entry)
        ...
        try {
            const response = await fetch('/api/analyze', {
                ...
                body: JSON.stringify({
                    ...
                    historyId: currentHistoryId // Pass history ID to update
                })
            })
            ...
            // Update existing history entry with AI response
            if (currentHistoryId) {
            ...
            <main className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8">
                <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* Results Card - Only show when calculating or showResult */}
                        ...
                        {/* AI Button - Only show when result is visible and not calculating */}
